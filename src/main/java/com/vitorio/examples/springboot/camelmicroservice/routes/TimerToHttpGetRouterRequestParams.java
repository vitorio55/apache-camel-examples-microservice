...
//@Component
public class TimerToHttpGetRouterRequestParams extends RouteBuilder {
	...
	public void configure() throws Exception {
	    ...
	    .to("http://localhost:8000/item/fetch-secret-item")
		    ...
		    .process(exchange -> {
		    	...
		    	exchange.setProperty("item-amount", fetchedItem.getAmount());
	    	})
		    .log("Amount: ${exchangeProperty.item-amount}");
	}
}
